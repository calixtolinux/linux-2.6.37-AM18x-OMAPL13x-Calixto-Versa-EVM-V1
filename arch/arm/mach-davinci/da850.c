...
static const struct mux_config da850_pins[] = {
	...
	MUX_CFG(DA850, UART0_CTS,       3,      24,     15,     2,      false)
        MUX_CFG(DA850, UART0_RTS,       3,      28,     15,     2,      false)
	...
	MUX_CFG(DA850, MMCSD0_CMD,	10,	4,	15,	2,	false)
        MUX_CFG(DA850, MMCSD0_CD,        0,     8 ,     15,     8,      false) 
...
const short da850_uart0_pins[] __initdata = {
	DA850_UART0_CTS, DA850_UART0_RTS, DA850_UART0_RXD, DA850_UART0_TXD,
	-1
};
...
const short da850_spi0_pins[] __initdata = {
        DA850_SPI0_CLK,  DA850_SPI0_SOMI,
        DA850_SPI0_SIMO, DA850_SPI0_ENA,
        -1
};

const short da850_cpgmac_pins[] __initdata = {
	DA850_MDIO_CLK,	  DA850_MDIO_D, 
        DA850_RMII_TXD_0, DA850_RMII_TXD_1, 
        DA850_RMII_TXEN,  DA850_RMII_CRS_DV, 
        DA850_RMII_RXD_0, DA850_RMII_RXD_1, 
        DA850_RMII_RXER,  DA850_RMII_MHZ_50_CLK,
	-1
};
...
const short da850_emif25_pins[] __initdata = {
	DA850_EMA_BA_1, DA850_EMA_CLK, DA850_EMA_WAIT_1, DA850_EMA_WAIT_0, DA850_NEMA_CS_2,
